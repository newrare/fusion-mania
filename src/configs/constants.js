...
export const BATTLE = {
  ...
  ENEMY_PROFILES: {
    ...
    // ── Nuclear (theme 6) ──
    // Nuclear wipes the ENTIRE board, so it is capped at 1 per enemy
    // (2 only for the dedicated nuclear-finale boss `armageddon`) and
    // always diluted with cheaper filler powers so it stays a rare threat.
    atomic_minor: {
