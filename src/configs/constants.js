...
export const BATTLE = {
  ...
  LEVEL_POWERS: {
    ...
    256:  [
      POWER_TYPES.ICE, POWER_TYPES.WIND_UP, POWER_TYPES.WIND_DOWN,
      POWER_TYPES.WIND_LEFT, POWER_TYPES.WIND_RIGHT,
      POWER_TYPES.EXPEL_V, POWER_TYPES.EXPEL_H, POWER_TYPES.BLIND,
      POWER_TYPES.FIRE_H, POWER_TYPES.FIRE_V, POWER_TYPES.TELEPORT,
      POWER_TYPES.LIGHTNING, POWER_TYPES.ADS,
    ],
    512:  [
      POWER_TYPES.ICE, POWER_TYPES.WIND_UP, POWER_TYPES.WIND_DOWN,
      POWER_TYPES.WIND_LEFT, POWER_TYPES.WIND_RIGHT,
      POWER_TYPES.EXPEL_V, POWER_TYPES.EXPEL_H, POWER_TYPES.BLIND,
      POWER_TYPES.FIRE_H, POWER_TYPES.FIRE_V, POWER_TYPES.FIRE_X,
      POWER_TYPES.TELEPORT, POWER_TYPES.LIGHTNING, POWER_TYPES.ADS,
    ],
    1024: [
      POWER_TYPES.ICE, POWER_TYPES.WIND_UP, POWER_TYPES.WIND_DOWN,
      POWER_TYPES.WIND_LEFT, POWER_TYPES.WIND_RIGHT,
      POWER_TYPES.EXPEL_V, POWER_TYPES.EXPEL_H, POWER_TYPES.BLIND,
      POWER_TYPES.FIRE_H, POWER_TYPES.FIRE_V, POWER_TYPES.FIRE_X,
      POWER_TYPES.BOMB, POWER_TYPES.TELEPORT, POWER_TYPES.LIGHTNING, POWER_TYPES.ADS,
    ],
    2048: [
      POWER_TYPES.ICE, POWER_TYPES.WIND_UP, POWER_TYPES.WIND_DOWN,
      POWER_TYPES.WIND_LEFT, POWER_TYPES.WIND_RIGHT,
      POWER_TYPES.EXPEL_V, POWER_TYPES.EXPEL_H, POWER_TYPES.BLIND,
      POWER_TYPES.FIRE_H, POWER_TYPES.FIRE_V, POWER_TYPES.FIRE_X,
      POWER_TYPES.BOMB, POWER_TYPES.NUCLEAR, POWER_TYPES.TELEPORT,
      POWER_TYPES.LIGHTNING, POWER_TYPES.ADS,
    ],
  },
