...
export const ENEMY_NAMES = [
  'Pythax', 'Numerix', 'Divisor', 'Algebrox', 'Tangix',
  'Fibonax', 'Sinusor', 'Cosinox', 'Derivox', 'Integrix',
  'Factorus', 'Primatus', 'Logarix', 'Exponix', 'Vectorix',
  'Matrixor', 'Fractalx', 'Polynox', 'Asymptox', 'Hypotex',
  'Calculix', 'Equatix', 'Theorix', 'Axiomix', 'Geometx',
  'Parallox', 'Trapezix', 'Octarix', 'Dodecax', 'Rhomboid',
  'Permutix', 'Combinax', 'Problix', 'Statistx', 'Medianor',
  'Deviatox', 'Correlax', 'Regressx', 'Infinix', 'Epsilox',
  'Deltaflx', 'Sigmazor', 'Pirator', 'Eulerox', 'Gaussix',
  'Riemanx', 'Hilbertx', 'Cantorus', 'Fermatix', 'Symetrix',
  'Barycenx', 'Radianix', 'Diametx', 'Circufex', 'Quotix',
  'Remaindx', 'Modulix', 'Congruex', 'Bisectx', 'Tangenox',
  'Parabolx', 'Hyperbox', 'Ellipsox', 'Secantx', 'Cosecax',
  'Cotagenx', 'Arcsinix', 'Lemmax', 'Corollix', 'Postulax',
  'Topologx', 'Morphix', 'Isometx', 'Affinix', 'Scalarix',
  'Tensorix', 'Eigenvax', 'Determnx', 'Compleux', 'Imaginax',
  'Rationix', 'Irratix', 'Transcex', 'Absolutx', 'Summator',
  'Productx', 'Seriesix', 'Convergx', 'Divergix', 'Limitus',
  'Continux', 'Differix', 'Laplacix', 'Fouriex', 'Newtonix',
  'Leibnizx', 'Bourbakx', 'Mandelx', 'Tesserix', 'Quaternx',
];
