export const en = {
  ...
  'options.reset_data_confirm': 'Delete all rankings, saves and level progress?',
  ...
  'options.reset_data_success': 'All data deleted!',
  'options.close': 'Close',
  ...
  'battle.level_select': 'Select Level',
  'battle.tier_easy': 'Easy',
  'battle.tier_normal': 'Normal',
  'battle.tier_hard': 'Hard',
  'battle.level': 'Level',
  'battle.level_bonus': 'Level Bonus',
  'battle.victory_bonus': 'Victory Bonus',
  'battle.boss': 'Boss',
  ...
  'history.close': 'Close',
  'history.empty': 'No fusion yet',
  'history.move': 'Move',
  'history.fusion': 'Fusion',
  'history.contamination': 'Contamination',
  'history.power': 'Power',
  'history.enemy_spawn': '{name} lv.{level} appeared',
  'history.enemy_damage': '{name} lv.{level} takes {damage} dmg',
  'history.enemy_defeated': '{name} lv.{level} defeated',
